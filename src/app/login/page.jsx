            ...
            <div className="backdrop-blur-xl w-full max-w-[900px] rounded-[2.5rem] shadow-2xl border border-white dark:border-zinc-800 overflow-hidden">
                <div className="p-8 sm:p-12">
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-zinc-500 dark:text-zinc-400">Please enter your details to login</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="space-y-6">
                        ...
                        >
                            <span className="flex items-center gap-2">
                                Login to Account <HiArrowRight className="group-hover:translate-x-1 transition-transform" />
                            </span>
                        </Button>
                    </form>
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-zinc-500 dark:text-zinc-400 font-medium">
                            ...
                            <Link className="text-blue-600 dark:text-blue-400 font-bold hover:underline underline-offset-4" href={"/registration"}>
                                Register
                            </Link>
                        </p>
                    </div>
