                ...
                <div className="p-8 sm:p-12">
                    <div className="mb-10">
                        <h2 className=" text-3xl md:text-4xl font-extrabold tracking-tight text-zinc-900 dark:text-white mb-2 text-center">
                            Registration your <span className="text-blue-600 dark:text-blue-500">Account</span>
                        </h2>
                    ...
                    <form onSubmit={handleSubmit(handleRegistration)} className="space-y-6">
                        <div className="group">
                            ...
                            <div className="relative">
                                <HiOutlineUser className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors z-10" size={20} />
                                <input
                                    type="text"
                                    ...
                                    {...register("name", { required: "Name is required to create account" })}
                                />
                            </div>
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <HiOutlinePhotograph className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors z-10" size={20} />
                                <input
                                    type="text"
                                    ...
                                    {...register("photoURL",{required : "Image is required for your profile"})}
                                />
                            </div>
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <HiOutlineMail className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors z-10" size={20} />
                                <input
                                    type="email"
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                <HiOutlineLockClosed className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors z-10" size={20} />
                                <input
                                    ...
                                    placeholder="••••••••"
                                    {...register("password", { required: "Password is must be required" })}
                                />
                                <button 
                                    type="button"
                                ...
                                >
                                    {isPasswordVisible ? <HiEyeOff size={22} /> : <HiEye size={22} />}
                                </button>
                            </div>
                        ...
                        >
                            <span className="flex items-center gap-2">
                                Registration Account <HiArrowRight className="group-hover:translate-x-1 transition-transform" />
                            </span>
                        </Button>
                    </form>
                    ...
                    <div className="mt-10">
                        <p className="text-zinc-500 dark:text-zinc-400 font-medium">
                            ...
                            <Link className="text-blue-600 dark:text-blue-400 font-bold hover:underline underline-offset-4" href={"/login"}>
                                Login
                            </Link>
                        </p>
                    </div>
